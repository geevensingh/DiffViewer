...
internal static class SettingsJsonSerializer
{
    ...
    public static string Serialize(AppSettings s)
    {
        var obj = new JsonObject
        {
            ...
            ["preferMarkdownRendered"] = s.PreferMarkdownRendered,
    ...
    public static AppSettings Deserialize(JsonObject obj)
    {
        ...
        return new AppSettings
        {
            ...
            RenderSvgImage = TryBool(obj, "renderSvgImage") ?? defaults.RenderSvgImage,
            PreferMarkdownRendered = TryBool(obj, "preferMarkdownRendered") ?? defaults.PreferMarkdownRendered,
